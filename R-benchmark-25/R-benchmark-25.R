...
set.seed=42
Runif <- runif
a <- runif(10) #, new.start=TRUE, seed=492166)	# Init. the generator
Rnorm <- RcppZiggurat::zrnorm	# The fast normal number generator
# If you don't have SuppDists, you can use: Rnorm <- rnorm
RcppZiggurat::zsetseed(42)
b <- RcppZiggurat::zrnorm(10)	# Init. the generator
remove("a", "b")
